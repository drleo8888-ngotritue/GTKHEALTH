...
import { 
  ...
  LogOut, 
  Activity,
  Monitor,      // Icon màn hình
  ExternalLink  // Icon mở cửa sổ mới
} from 'lucide-react';
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm z-20 shrink-0">
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-100">
           <div className="flex items-center gap-2 select-none cursor-default">
             <div className="w-8 h-8 rounded bg-green-600 flex items-center justify-center text-white font-bold text-lg shadow-sm">G</div>
             <div className="flex flex-col justify-center">
               <div className="text-xl font-bold tracking-tight leading-none text-gray-800">
                 Goertek<span className="text-green-600">Care</span>
               </div>
               <span className="text-[10px] text-gray-400 font-bold tracking-wider uppercase">Smart Medical</span>
             </div>
          </div>
        </div>
