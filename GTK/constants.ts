...
export const STAFF_LIST: User[] = [
  ...
  { id: '5', name: 'TRẦN THI PHƯƠNG', role: Role.STAFF, canPrescribe: true },
  { id: '6', name: 'NGUYỄN THỊ HĂNG', role: Role.STAFF, canPrescribe: true },
  { id: '7', name: 'CHU THỊ DÂNG', role: Role.STAFF, canPrescribe: true },
  { id: '8', name: 'NGUYÊN THỊ THU THỦY', role: Role.STAFF, canPrescribe: true },
  { id: '9', name: 'NGUYỄN THI HUYÈN', role: Role.STAFF, canPrescribe: true },
  { id: '10', name: 'NGUYÊN THÚY TRÀ', role: Role.STAFF, canPrescribe: true },
  { id: '11', name: 'VŪ THI HÀ', role: Role.STAFF, canPrescribe: true },
