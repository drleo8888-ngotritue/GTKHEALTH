...
declare global {
  interface Window {
    electron: {
      ...
      listIncomingTransfers:     () => Promise<{ success: boolean; data: any[]; message?: string }>;
      receiveTransfer:           (p: { transfer: any; actorName?: string; actorRole?: string }) => Promise<{ success: boolean; message?: string }>;
      ...
      queryServerEncounters: (params: { from?: number; to?: number; stationId?: string; stationName?: string; patientId?: string; limit?: number; offset?: number; diseaseGroup?: string; diseaseGroupNot?: string; status?: string; hadRest?: boolean }) => Promise<{ success: boolean; data: any[]; total?: number; message?: string }>;
      ...
      getServerEncounterEvents: (encounterId: string) => Promise<{ success: boolean; data: any[]; message?: string }>;
